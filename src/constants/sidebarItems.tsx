...
export const sidebarItems = (role: string) => {
  ...
  if (role === ENUM_USER_ROLES.SUPER_ADMIN) return superAdminSidebarItems;
  else if (role === ENUM_USER_ROLES.ADMIN) return adminSidebarItems;
  else if (role === ENUM_USER_ROLES.FACULTY) return facultySidebarItems;
  else if (role === ENUM_USER_ROLES.STUDENT) return studentSidebarItems;
  else {
